...
#define GPIO_IDR_ADDR(X)	(0x40040008 + ((X&0xf0)>>4)*0x400 + (X&0x0f))
#define GPIO_ODR_ADDR(X)	(0x4004000C + ((X&0xf0)>>4)*0x400 + (X&0x0f))
#define GPIO_BSRR_ADDR(X)	(0x40040010 + ((X&0xf0)>>4)*0x400 + (X&0x0f))
#define GPIO_BRR_ADDR(X)	(0x40040014 + ((X&0xf0)>>4)*0x400 + (X&0x0f))
...
void nvic_init(IRQn_Type irqn, uint8 preemption_priority, uint8 sub_priority, FunctionalState status);
