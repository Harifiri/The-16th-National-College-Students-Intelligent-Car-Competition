...
// @return		void
// Sample usage:				tim_interrupt_init(TIM_1, 1, 0x00, 0x00);
//-------------------------------------------------------------------------------------------------------------------
void tim_interrupt_init (TIM_enum tim, uint32 freq, uint8 preemption_priority, uint8 sub_priority)
{
...
// @return		void
// Sample usage:				tim_interrupt_init_us(TIM_1, 1, 0x00, 0x00);
//-------------------------------------------------------------------------------------------------------------------
void tim_interrupt_init_us (TIM_enum tim, uint32 timer, uint8 preemption_priority, uint8 sub_priority)
{
	...
	NVIC_InitTypeDef NVIC_InitStructure;														// 中断配置结构体
	uint16 freq_div = 0;																		// 计算预分频
	uint16 period_temp = timer*120-1;															// 计算自动重装载值
...
// @param		priority		选择该中断优先级 范围 [0-3]
// @return		void
// Sample usage:				tim_interrupt_init_ms(TIM_1, 1, 0x00, 0x00);
//-------------------------------------------------------------------------------------------------------------------
void tim_interrupt_init_ms (TIM_enum tim, uint32 timer, uint8 preemption_priority, uint8 sub_priority)
{
