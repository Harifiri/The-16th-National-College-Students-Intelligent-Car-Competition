...
#define ABS_ENCODER_SPI_SCK_PIN		SPI3_SCK_B03
#define ABS_ENCODER_SPI_MOSI_PIN	SPI3_MOSI_B05
#define ABS_ENCODER_SPI_MISO_PIN	SPI3_MISO_B04
#define ABS_ENCODER_SPI_PCS_PIN		C6

#define ABS_ENCODER_SPI_CSN(x)		(x? (GPIO_PIN_SET(ABS_ENCODER_SPI_PCS_PIN)): (GPIO_PIN_RESET(ABS_ENCODER_SPI_PCS_PIN)))
//------------------------硬件SPI--------------------------//
