...
#define OV7725_UART_COF_UART			UART_8								// 小钻风配置串口
#define OV7725_UART_COF_BAUR			9600								// 小钻风配置串口波特率
#define OV7725_UART_COF_UART_TX			UART8_TX_E01						// 小钻风TX串口引脚
#define OV7725_UART_COF_UART_RX			UART8_RX_E00						// 小钻风RX串口引脚

#define OV7725_UART_DMA_CH				DMA1_Channel4						// TIM触发DMA通道禁止随意修改
#define OV7725_UART_DMA_IRQN			DMA1_Channel4_IRQn					// DMA中断通道

#define OV7725_UART_PCLK				TIM_1_ETR_E07						// GPIO触发TIM引脚禁止随意修改

#define OV7725_UART_VSYNC_PIN			E8									// 场中断引脚
#define OV7725_UART_VSYNC_IRQN			EXTI9_5_IRQn						// 中断号

#define OV7725_UART_DATA_PIN			F0
