...
//--------------------------------------------------------------------------------------------------
// 软件 IIC 定义
#define OV7725_SCL_PIN			E0													// 定义SCL引脚  可任意更改为其他IO
#define OV7725_SDA_PIN			E1													// 定义SDA引脚  可任意更改为其他IO

#define OV7725_SDA				gpio_get(OV7725_SDA_PIN)
#define OV7725_SDA0()			GPIO_PIN_RESET(OV7725_SDA_PIN)						// IO口输出低电平
...
extern uint8_t ov7725_finish_flag;
extern uint8_t ov7725_image_bin [OV7725_H][OV7725_W/8];
...
//void seekfree_sendimg_7725(UARTN_enum uartn, void *imgaddr, uint32 imgsize);		// 这个函数与 串口版本小钻风共用
