...
//-----------------引脚定义------------------------------
#define IPS114_SPIN				SPI_3										// 定义使用的SPI号
#define IPS114_SCL_PIN		SPI3_SCK_D04								// 定义SPI_SCK引脚
#define IPS114_SDA_PIN		SPI3_MOSI_D06								// 定义SPI_MOSI引脚

#define IPS114_REST_PIN		D13											// 液晶复位引脚定义 由于实际通讯未使用B2因此 这里复用为GPIO
#define IPS114_DC_PIN			D5											// 液晶命令位引脚定义
#define IPS114_CS_PIN			D7											// 定义SPI_CS引脚
#define IPS114_BL_PIN			D11											// 液晶背光引脚定义
