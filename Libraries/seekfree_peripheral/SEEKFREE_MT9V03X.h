...
#define MT9V03X_W               180		// 图像宽度  范围1-752
...
#define MT9V03X_COF_UART_TX		UART8_TX_E01
#define MT9V03X_COF_UART_RX		UART8_RX_E00

#define MT9V03X_DMA_CH			DMA1_Channel4
#define MT9V03X_DMA_IRQN		DMA1_Channel4_IRQn

#define MT9V03X_TIMETR_PCLK		TIM_1_ETR_E07								// GPIO触发TIM引脚禁止随意修改

#define MT9V03X_VSYNC_PIN		E8											// 场中断引脚
#define MT9V03X_VSYNC_IRQN		EXTI9_5_IRQn								// 中断号

#define MT9V03X_DATA_PIN		F0
