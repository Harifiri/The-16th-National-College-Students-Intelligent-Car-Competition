...
void icm20602_init_spi(void)
{
	...
	//补偿  -25 -3 3
	icm_spi_w_reg_byte(0x13,0x00);//高八位
	icm_spi_w_reg_byte(0x14,0x3b);//低八位
	icm_spi_w_reg_byte(0x15,0x00);
	icm_spi_w_reg_byte(0x16,0x05);
	icm_spi_w_reg_byte(0x17,0x00);
	icm_spi_w_reg_byte(0x18,0x06);
}
